...
export const STAGES = Object.freeze([
  Object.freeze({
    code: "submitted",
    label: "Submitted",
    note: "Submitted. Waiting for intake review.",
    workflow: workflow(
  ...
  Object.freeze({
    code: "intake",
    label: "Intake review",
    note: "Intake review in progress.",
    workflow: workflow(
      "Matt started the intake review.",
  ...
  Object.freeze({
    ...
    workflow: workflow(
      "The report was accepted and research began.",
      "Matt prepares the comparable candidates.",
      "Matt",
    ),
  }),
  Object.freeze({
    code: "comparables",
    label: "Comparable candidates",
    note: "Comparable candidates prepared.",
    workflow: workflow(
      "Comparable candidates were prepared.",
      "Draft production begins. Reply in the order thread if you want to steer the set.",
      "Matt",
    ),
  }),
  Object.freeze({
    ...
    note: "Draft production in progress.",
    workflow: workflow(
      "Comparable candidates were prepared and drafting began.",
  ...
  Object.freeze({
    code: "review",
    label: "Matt's review",
    note: "Matt's review in progress.",
    workflow: workflow(
      "Draft production finished and Matt's review began.",
