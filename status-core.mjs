...
export const STAGES = Object.freeze([
  ...
  Object.freeze({
    ...
    workflow: workflow(
      ...
      "Matt gathers the comp set.",
      "Matt",
    ),
  }),
  Object.freeze({
    code: "comparables",
    label: "Comp set in hand",
    note: "Comp set in hand.",
    workflow: workflow(
      "The comp set was gathered and cross-checked.",
      "Report preparation begins. Reply in the order thread if you want a comp swapped.",
      "Matt",
    ),
  }),
  Object.freeze({
    ...
    note: "Report preparation in progress.",
    workflow: workflow(
      "The comp set was settled and report preparation began.",
      "Matt finishes the write-up, then runs the rules check.",
      "Matt",
    ),
  }),
  Object.freeze({
    code: "validation",
    label: "Validation and rules check",
    note: "Validation and rules check in progress.",
    workflow: workflow(
      "Report preparation finished and the rules check began.",
  ...
  Object.freeze({
    ...
    note: "Report delivered to you. The desk\u2019s part is done.",
    workflow: workflow(
